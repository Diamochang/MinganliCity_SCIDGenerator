...
#Python 第一版 无二维码 | Python v1 No QRCode
...
if sys.version_info >= (3,5):
    print("Python 版本符合要求（",python_version(),"，最低要求 3.5.0）",sep='')
else:
    print("Python 版本不符合最低要求 3.5.0。对于低于 3.5 的 Python 3 版本，请手动移除（或注释）掉条形码相关代码。在 Python 2 上直接运行本程序会有兼容性问题，请参考 https://docs.python.org/3/howto/pyporting.html 修改程序使其兼容 Python 2。")
    sys.exit(0) #返回不兼容信息后直接终止程序
...
def Generate():
    ...
    print("正在生成条形码......")
    BarcodeFile = "SCID-" + ID
    Barcode = barcode.get('code128',ID,writer=ImageWriter)
